...
*Última actualización: 2026-08-23 (Fase 12 CopilotKit v1→v2 + A2UI — implementado y verificado build/lint/runtime; limitación de key Gemini documentada) — Contrato vivo de Copixi. Cualquier desviación debe justificarse según §41.*
